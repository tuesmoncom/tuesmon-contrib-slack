...
from tuesmon.users.services import get_user_photo_url
...
def change_slackhook(url, channel, notify_config, obj, change):
    ...
    # Get markdown fields
    if change.diff:
        template_field = loader.get_template('tuesmon_contrib_slack/field-diff.jinja')
    ...
    try:
        ...
        data["icon_url"] = getattr(settings, "SLACKHOOKS_ICON", "https://manage.tuesmon.com/images/favicon.png")
...
def test_slackhook(url, channel):
    ...
    data["username"] = getattr(settings, "SLACKHOOKS_USERNAME", "Tuesmon")
    data["icon_url"] = getattr(settings, "SLACKHOOKS_ICON", "https://manage.tuesmon.com/images/favicon.png")
    _send_request(url, data)
